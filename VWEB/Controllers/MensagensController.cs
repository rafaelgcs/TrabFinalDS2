...
namespace VWEB.Controllers
{
    public class MensagensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Titulo,Texto,Data,TipoMensagem")] Mensagem mensagem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Titulo,Texto,Data,ComImagem,Imagem,TipoMensagem")] Mensagem mensagem)
        {
            if (ModelState.IsValid)
            {
